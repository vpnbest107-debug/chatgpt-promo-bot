...
def create_files():
    """إنشاء جميع الملفات"""
    print("\n" + "=" * 60)
    print("📁 إنشاء ملفات ChatGPT Promo Scanner")
    print("=" * 60)
    
    # إنشاء المجلد الرئيسي
    folder_name = 'chatgpt-promo-bot'
    ...
    print(f"\n📁 الموقع: {os.getcwd()}")
    print("\n📌 الخطوات التالية:")
    print("1. افتح ملف .env وأضف التوكنات الحقيقية")
    print("2. ارفع المجلد إلى GitHub")
    print("3. انشر على Render")
    print("=" * 60)
